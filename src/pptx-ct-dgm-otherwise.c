...
typedef struct pptx_ct_dgm_otherwise_s {
...
pptx_ct_dgm_otherwise *
pptx_ct_dgm_otherwise_new(xmlNode *node)
{
    pptx_ct_dgm_otherwise *obj;
...
pptx_ct_dgm_otherwise_get_alg(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->alg;
}

pptx_ct_dgm_shape **
pptx_ct_dgm_otherwise_get_shape(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->shape;
}

pptx_ct_dgm_presentation_of **
pptx_ct_dgm_otherwise_get_pres_of(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->pres_of;
}

pptx_ct_dgm_constraints **
pptx_ct_dgm_otherwise_get_constr_lst(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->constr_lst;
}

pptx_ct_dgm_rules **
pptx_ct_dgm_otherwise_get_rule_lst(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->rule_lst;
}

pptx_ct_dgm_for_each **
pptx_ct_dgm_otherwise_get_for_each(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->for_each;
}

pptx_ct_dgm_layout_node **
pptx_ct_dgm_otherwise_get_layout_node(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->layout_node;
}

pptx_ct_dgm_choose **
pptx_ct_dgm_otherwise_get_choose(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->choose;
}

pptx_ct_a_office_art_extension_list **
pptx_ct_dgm_otherwise_get_ext_lst(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->ext_lst;
}

pptx_string 
pptx_ct_dgm_otherwise_get_name(const pptx_ct_dgm_otherwise *const obj)
{
    return obj->name;
}

int32_t
pptx_ct_dgm_otherwise_get_index(pptx_ct_dgm_otherwise *obj)
{
    return obj->index;
}

void
pptx_ct_dgm_otherwise_free(pptx_ct_dgm_otherwise *obj)
{
    if (obj == NULL)
        return;
    if (obj->alg != NULL) {
