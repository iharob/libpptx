...
typedef struct pptx_ct_a_fill_overlay_effect_s {
...
pptx_ct_a_fill_overlay_effect *
pptx_ct_a_fill_overlay_effect_new(xmlNode *node)
{
    pptx_ct_a_fill_overlay_effect *obj;
...
pptx_ct_a_fill_overlay_effect_get_fill_properties_no_fill(const pptx_ct_a_fill_overlay_effect *const obj)
{
    return obj->fill_properties_no_fill;
}

pptx_ct_a_solid_color_fill_properties *
pptx_ct_a_fill_overlay_effect_get_fill_properties_solid_fill(const pptx_ct_a_fill_overlay_effect *const obj)
{
    return obj->fill_properties_solid_fill;
}

pptx_ct_a_gradient_fill_properties *
pptx_ct_a_fill_overlay_effect_get_fill_properties_grad_fill(const pptx_ct_a_fill_overlay_effect *const obj)
{
    return obj->fill_properties_grad_fill;
}

pptx_ct_a_blip_fill_properties *
pptx_ct_a_fill_overlay_effect_get_fill_properties_blip_fill(const pptx_ct_a_fill_overlay_effect *const obj)
{
    return obj->fill_properties_blip_fill;
}

pptx_ct_a_pattern_fill_properties *
pptx_ct_a_fill_overlay_effect_get_fill_properties_patt_fill(const pptx_ct_a_fill_overlay_effect *const obj)
{
    return obj->fill_properties_patt_fill;
}

pptx_ct_a_group_fill_properties *
pptx_ct_a_fill_overlay_effect_get_fill_properties_grp_fill(const pptx_ct_a_fill_overlay_effect *const obj)
{
    return obj->fill_properties_grp_fill;
}

pptx_st_blend_mode_token_enum 
pptx_ct_a_fill_overlay_effect_get_blend(const pptx_ct_a_fill_overlay_effect *const obj)
{
    return obj->blend;
}

int32_t
pptx_ct_a_fill_overlay_effect_get_index(pptx_ct_a_fill_overlay_effect *obj)
{
    return obj->index;
}

void
pptx_ct_a_fill_overlay_effect_free(pptx_ct_a_fill_overlay_effect *obj)
{
    if (obj == NULL)
        return;
