...
typedef struct pptx_ct_a_style_matrix_reference_s {
...
pptx_ct_a_style_matrix_reference *
pptx_ct_a_style_matrix_reference_new(xmlNode *node)
{
    pptx_ct_a_style_matrix_reference *obj;
...
pptx_ct_a_style_matrix_reference_get_color_choice_scrgb_clr(const pptx_ct_a_style_matrix_reference *const obj)
{
    return obj->color_choice_scrgb_clr;
}

pptx_ct_a_srgb_color *
pptx_ct_a_style_matrix_reference_get_color_choice_srgb_clr(const pptx_ct_a_style_matrix_reference *const obj)
{
    return obj->color_choice_srgb_clr;
}

pptx_ct_a_hsl_color *
pptx_ct_a_style_matrix_reference_get_color_choice_hsl_clr(const pptx_ct_a_style_matrix_reference *const obj)
{
    return obj->color_choice_hsl_clr;
}

pptx_ct_a_system_color *
pptx_ct_a_style_matrix_reference_get_color_choice_sys_clr(const pptx_ct_a_style_matrix_reference *const obj)
{
    return obj->color_choice_sys_clr;
}

pptx_ct_a_scheme_color *
pptx_ct_a_style_matrix_reference_get_color_choice_scheme_clr(const pptx_ct_a_style_matrix_reference *const obj)
{
    return obj->color_choice_scheme_clr;
}

pptx_ct_a_preset_color *
pptx_ct_a_style_matrix_reference_get_color_choice_prst_clr(const pptx_ct_a_style_matrix_reference *const obj)
{
    return obj->color_choice_prst_clr;
}

pptx_uint 
pptx_ct_a_style_matrix_reference_get_idx(const pptx_ct_a_style_matrix_reference *const obj)
{
    return obj->idx;
}

int32_t
pptx_ct_a_style_matrix_reference_get_index(pptx_ct_a_style_matrix_reference *obj)
{
    return obj->index;
}

void
pptx_ct_a_style_matrix_reference_free(pptx_ct_a_style_matrix_reference *obj)
{
    if (obj == NULL)
        return;
