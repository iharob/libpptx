...
typedef struct pptx_ct_a_date_ax_s {
    ...
    pptx_ct_a_time_unit *base_time_unit;
    pptx_ct_a_axis_unit *major_unit;
    pptx_ct_a_time_unit *major_time_unit;
    pptx_ct_a_axis_unit *minor_unit;
    pptx_ct_a_time_unit *minor_time_unit;
    pptx_ct_a_extension_list *ext_lst;
    int32_t index;
} pptx_ct_a_date_ax;

pptx_ct_a_date_ax *
pptx_ct_a_date_ax_new(xmlNode *node)
{
    pptx_ct_a_date_ax *obj;
    ...
    xpath = pptx_xml_find_node(node, (const xmlChar *) "a:baseTimeUnit");
    if (xpath != NULL) {
        xmlNodeSet *nodes;
        nodes = xpath->nodesetval;
        if ((nodes->nodeNr != 1) || (nodes->nodeNr < -1)) {       
            obj->base_time_unit = NULL;
        } else {
            obj->base_time_unit = pptx_ct_a_time_unit_new(nodes->nodeTab[0]);
        }
        xmlXPathFreeObject(xpath);
    } else {
        obj->base_time_unit = NULL;
    ...
    xpath = pptx_xml_find_node(node, (const xmlChar *) "a:majorTimeUnit");
    if (xpath != NULL) {
        xmlNodeSet *nodes;
        nodes = xpath->nodesetval;
        if ((nodes->nodeNr != 1) || (nodes->nodeNr < -1)) {       
            obj->major_time_unit = NULL;
        } else {
            obj->major_time_unit = pptx_ct_a_time_unit_new(nodes->nodeTab[0]);
        }
        xmlXPathFreeObject(xpath);
    } else {
        obj->major_time_unit = NULL;
    ...
    xpath = pptx_xml_find_node(node, (const xmlChar *) "a:minorTimeUnit");
    if (xpath != NULL) {
        xmlNodeSet *nodes;
        nodes = xpath->nodesetval;
        if ((nodes->nodeNr != 1) || (nodes->nodeNr < -1)) {       
            obj->minor_time_unit = NULL;
        } else {
            obj->minor_time_unit = pptx_ct_a_time_unit_new(nodes->nodeTab[0]);
        }
        xmlXPathFreeObject(xpath);
    } else {
        obj->minor_time_unit = NULL;
...
pptx_uint 
pptx_ct_a_date_ax_get_ax_shared_ax_id(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_ax_id;
}

pptx_ct_a_scaling *
pptx_ct_a_date_ax_get_ax_shared_scaling(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_scaling;
}

pptx_bool 
pptx_ct_a_date_ax_get_ax_shared_delete(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_delete;
}

pptx_ct_a_ax_pos *
pptx_ct_a_date_ax_get_ax_shared_ax_pos(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_ax_pos;
}

pptx_ct_a_chart_lines *
pptx_ct_a_date_ax_get_ax_shared_major_gridlines(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_major_gridlines;
}

pptx_ct_a_chart_lines *
pptx_ct_a_date_ax_get_ax_shared_minor_gridlines(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_minor_gridlines;
}

pptx_ct_a_title *
pptx_ct_a_date_ax_get_ax_shared_title(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_title;
}

pptx_ct_a_num_fmt *
pptx_ct_a_date_ax_get_ax_shared_num_fmt(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_num_fmt;
}

pptx_ct_a_tick_mark *
pptx_ct_a_date_ax_get_ax_shared_major_tick_mark(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_major_tick_mark;
}

pptx_ct_a_tick_mark *
pptx_ct_a_date_ax_get_ax_shared_minor_tick_mark(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_minor_tick_mark;
}

pptx_ct_a_tick_lbl_pos *
pptx_ct_a_date_ax_get_ax_shared_tick_lbl_pos(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_tick_lbl_pos;
}

pptx_ct_a_shape_properties *
pptx_ct_a_date_ax_get_ax_shared_sp_pr(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_sp_pr;
}

pptx_ct_a_text_body *
pptx_ct_a_date_ax_get_ax_shared_tx_pr(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_tx_pr;
}

pptx_uint 
pptx_ct_a_date_ax_get_ax_shared_cross_ax(const pptx_ct_a_date_ax *const obj)
{
    return obj->ax_shared_cross_ax;
}

pptx_ct_a_crosses *
pptx_ct_a_date_ax_get_crosses(const pptx_ct_a_date_ax *const obj)
{
    return obj->crosses;
}

pptx_ct_a_double *
pptx_ct_a_date_ax_get_crosses_at(const pptx_ct_a_date_ax *const obj)
{
    return obj->crosses_at;
}

pptx_bool 
pptx_ct_a_date_ax_get__auto(const pptx_ct_a_date_ax *const obj)
{
    return obj->_auto;
}

pptx_ct_a_lbl_offset *
pptx_ct_a_date_ax_get_lbl_offset(const pptx_ct_a_date_ax *const obj)
{
    return obj->lbl_offset;
}

pptx_ct_a_time_unit *
pptx_ct_a_date_ax_get_base_time_unit(const pptx_ct_a_date_ax *const obj)
{
    return obj->base_time_unit;
}

pptx_ct_a_axis_unit *
pptx_ct_a_date_ax_get_major_unit(const pptx_ct_a_date_ax *const obj)
{
    return obj->major_unit;
}

pptx_ct_a_time_unit *
pptx_ct_a_date_ax_get_major_time_unit(const pptx_ct_a_date_ax *const obj)
{
    return obj->major_time_unit;
}

pptx_ct_a_axis_unit *
pptx_ct_a_date_ax_get_minor_unit(const pptx_ct_a_date_ax *const obj)
{
    return obj->minor_unit;
}

pptx_ct_a_time_unit *
pptx_ct_a_date_ax_get_minor_time_unit(const pptx_ct_a_date_ax *const obj)
{
    return obj->minor_time_unit;
}

pptx_ct_a_extension_list *
pptx_ct_a_date_ax_get_ext_lst(const pptx_ct_a_date_ax *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_a_date_ax_get_index(pptx_ct_a_date_ax *obj)
{
    return obj->index;
}

void
pptx_ct_a_date_ax_free(pptx_ct_a_date_ax *obj)
{
    if (obj == NULL)
        return;
    ...
    pptx_ct_a_time_unit_free(obj->base_time_unit);
    pptx_ct_a_axis_unit_free(obj->major_unit);
    pptx_ct_a_time_unit_free(obj->major_time_unit);
    pptx_ct_a_axis_unit_free(obj->minor_unit);
    pptx_ct_a_time_unit_free(obj->minor_time_unit);
