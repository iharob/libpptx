...
typedef struct pptx_ct_a_transform_2d_s {
...
pptx_ct_a_transform_2d *
pptx_ct_a_transform_2d_new(xmlNode *node)
{
    pptx_ct_a_transform_2d *obj;
...
pptx_ct_a_point_2d *
pptx_ct_a_transform_2d_get_off(const pptx_ct_a_transform_2d *const obj)
{
    return obj->off;
}

pptx_ct_a_positive_size_2d *
pptx_ct_a_transform_2d_get_ext(const pptx_ct_a_transform_2d *const obj)
{
    return obj->ext;
}

pptx_int 
pptx_ct_a_transform_2d_get_rot(const pptx_ct_a_transform_2d *const obj)
{
    return obj->rot;
}

pptx_bool 
pptx_ct_a_transform_2d_get_flip_h(const pptx_ct_a_transform_2d *const obj)
{
    return obj->flip_h;
}

pptx_bool 
pptx_ct_a_transform_2d_get_flip_v(const pptx_ct_a_transform_2d *const obj)
{
    return obj->flip_v;
}

int32_t
pptx_ct_a_transform_2d_get_index(pptx_ct_a_transform_2d *obj)
{
    return obj->index;
}

void
pptx_ct_a_transform_2d_free(pptx_ct_a_transform_2d *obj)
{
    if (obj == NULL)
        return;
