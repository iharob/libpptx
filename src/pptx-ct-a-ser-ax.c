...
typedef struct pptx_ct_a_ser_ax_s {
...
pptx_ct_a_ser_ax *
pptx_ct_a_ser_ax_new(xmlNode *node)
{
    pptx_ct_a_ser_ax *obj;
...
pptx_uint 
pptx_ct_a_ser_ax_get_ax_shared_ax_id(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_ax_id;
}

pptx_ct_a_scaling *
pptx_ct_a_ser_ax_get_ax_shared_scaling(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_scaling;
}

pptx_bool 
pptx_ct_a_ser_ax_get_ax_shared_delete(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_delete;
}

pptx_ct_a_ax_pos *
pptx_ct_a_ser_ax_get_ax_shared_ax_pos(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_ax_pos;
}

pptx_ct_a_chart_lines *
pptx_ct_a_ser_ax_get_ax_shared_major_gridlines(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_major_gridlines;
}

pptx_ct_a_chart_lines *
pptx_ct_a_ser_ax_get_ax_shared_minor_gridlines(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_minor_gridlines;
}

pptx_ct_a_title *
pptx_ct_a_ser_ax_get_ax_shared_title(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_title;
}

pptx_ct_a_num_fmt *
pptx_ct_a_ser_ax_get_ax_shared_num_fmt(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_num_fmt;
}

pptx_ct_a_tick_mark *
pptx_ct_a_ser_ax_get_ax_shared_major_tick_mark(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_major_tick_mark;
}

pptx_ct_a_tick_mark *
pptx_ct_a_ser_ax_get_ax_shared_minor_tick_mark(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_minor_tick_mark;
}

pptx_ct_a_tick_lbl_pos *
pptx_ct_a_ser_ax_get_ax_shared_tick_lbl_pos(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_tick_lbl_pos;
}

pptx_ct_a_shape_properties *
pptx_ct_a_ser_ax_get_ax_shared_sp_pr(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_sp_pr;
}

pptx_ct_a_text_body *
pptx_ct_a_ser_ax_get_ax_shared_tx_pr(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_tx_pr;
}

pptx_uint 
pptx_ct_a_ser_ax_get_ax_shared_cross_ax(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ax_shared_cross_ax;
}

pptx_ct_a_crosses *
pptx_ct_a_ser_ax_get_crosses(const pptx_ct_a_ser_ax *const obj)
{
    return obj->crosses;
}

pptx_ct_a_double *
pptx_ct_a_ser_ax_get_crosses_at(const pptx_ct_a_ser_ax *const obj)
{
    return obj->crosses_at;
}

pptx_ct_a_skip *
pptx_ct_a_ser_ax_get_tick_lbl_skip(const pptx_ct_a_ser_ax *const obj)
{
    return obj->tick_lbl_skip;
}

pptx_ct_a_skip *
pptx_ct_a_ser_ax_get_tick_mark_skip(const pptx_ct_a_ser_ax *const obj)
{
    return obj->tick_mark_skip;
}

pptx_ct_a_extension_list *
pptx_ct_a_ser_ax_get_ext_lst(const pptx_ct_a_ser_ax *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_a_ser_ax_get_index(pptx_ct_a_ser_ax *obj)
{
    return obj->index;
}

void
pptx_ct_a_ser_ax_free(pptx_ct_a_ser_ax *obj)
{
    if (obj == NULL)
        return;
