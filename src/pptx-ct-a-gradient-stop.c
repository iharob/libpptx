...
typedef struct pptx_ct_a_gradient_stop_s {
    ...
    pptx_string pos;
    int32_t index;
} pptx_ct_a_gradient_stop;

pptx_ct_a_gradient_stop *
pptx_ct_a_gradient_stop_new(xmlNode *node)
{
    pptx_ct_a_gradient_stop *obj;
...
pptx_ct_a_gradient_stop_get_color_choice_scrgb_clr(const pptx_ct_a_gradient_stop *const obj)
{
    return obj->color_choice_scrgb_clr;
}

pptx_ct_a_srgb_color *
pptx_ct_a_gradient_stop_get_color_choice_srgb_clr(const pptx_ct_a_gradient_stop *const obj)
{
    return obj->color_choice_srgb_clr;
}

pptx_ct_a_hsl_color *
pptx_ct_a_gradient_stop_get_color_choice_hsl_clr(const pptx_ct_a_gradient_stop *const obj)
{
    return obj->color_choice_hsl_clr;
}

pptx_ct_a_system_color *
pptx_ct_a_gradient_stop_get_color_choice_sys_clr(const pptx_ct_a_gradient_stop *const obj)
{
    return obj->color_choice_sys_clr;
}

pptx_ct_a_scheme_color *
pptx_ct_a_gradient_stop_get_color_choice_scheme_clr(const pptx_ct_a_gradient_stop *const obj)
{
    return obj->color_choice_scheme_clr;
}

pptx_ct_a_preset_color *
pptx_ct_a_gradient_stop_get_color_choice_prst_clr(const pptx_ct_a_gradient_stop *const obj)
{
    return obj->color_choice_prst_clr;
}

pptx_string 
pptx_ct_a_gradient_stop_get_pos(const pptx_ct_a_gradient_stop *const obj)
{
    return obj->pos;
}

int32_t
pptx_ct_a_gradient_stop_get_index(pptx_ct_a_gradient_stop *obj)
{
    return obj->index;
}

void
pptx_ct_a_gradient_stop_free(pptx_ct_a_gradient_stop *obj)
{
    if (obj == NULL)
        return;
