...
typedef struct pptx_ct_a_surface_3dchart_s {
...
pptx_ct_a_surface_3dchart *
pptx_ct_a_surface_3dchart_new(xmlNode *node)
{
    pptx_ct_a_surface_3dchart *obj;
...
pptx_bool 
pptx_ct_a_surface_3dchart_get_surface_chart_shared_wireframe(const pptx_ct_a_surface_3dchart *const obj)
{
    return obj->surface_chart_shared_wireframe;
}

pptx_ct_a_surface_ser **
pptx_ct_a_surface_3dchart_get_surface_chart_shared_ser(const pptx_ct_a_surface_3dchart *const obj)
{
    return obj->surface_chart_shared_ser;
}

pptx_ct_a_band_fmts *
pptx_ct_a_surface_3dchart_get_surface_chart_shared_band_fmts(const pptx_ct_a_surface_3dchart *const obj)
{
    return obj->surface_chart_shared_band_fmts;
}

pptx_ct_a_extension_list *
pptx_ct_a_surface_3dchart_get_ext_lst(const pptx_ct_a_surface_3dchart *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_a_surface_3dchart_get_index(pptx_ct_a_surface_3dchart *obj)
{
    return obj->index;
}

void
pptx_ct_a_surface_3dchart_free(pptx_ct_a_surface_3dchart *obj)
{
    if (obj == NULL)
        return;
    if (obj->surface_chart_shared_ser != NULL) {
