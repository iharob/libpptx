...
typedef struct pptx_ct_dgm_when_s {
    ...
    pptx_uint cnt;
    pptx_int step;
    pptx_st_function_type_token_enum func;
    pptx_st_variable_type_token_enum arg;
    pptx_st_function_operator_token_enum op;
    pptx_st_resize_handles_str_token_enum val;
    int32_t index;
} pptx_ct_dgm_when;

pptx_ct_dgm_when *
pptx_ct_dgm_when_new(xmlNode *node)
{
    pptx_ct_dgm_when *obj;
    ...
    obj->func = pptx_get_st_function_type(node, (const xmlChar *) "func");
    obj->arg = pptx_get_st_variable_type(node, (const xmlChar *) "arg");
    obj->op = pptx_get_st_function_operator(node, (const xmlChar *) "op");
...
pptx_ct_dgm_when_get_alg(const pptx_ct_dgm_when *const obj)
{
    return obj->alg;
}

pptx_ct_dgm_shape **
pptx_ct_dgm_when_get_shape(const pptx_ct_dgm_when *const obj)
{
    return obj->shape;
}

pptx_ct_dgm_presentation_of **
pptx_ct_dgm_when_get_pres_of(const pptx_ct_dgm_when *const obj)
{
    return obj->pres_of;
}

pptx_ct_dgm_constraints **
pptx_ct_dgm_when_get_constr_lst(const pptx_ct_dgm_when *const obj)
{
    return obj->constr_lst;
}

pptx_ct_dgm_rules **
pptx_ct_dgm_when_get_rule_lst(const pptx_ct_dgm_when *const obj)
{
    return obj->rule_lst;
}

pptx_ct_dgm_for_each **
pptx_ct_dgm_when_get_for_each(const pptx_ct_dgm_when *const obj)
{
    return obj->for_each;
}

pptx_ct_dgm_layout_node **
pptx_ct_dgm_when_get_layout_node(const pptx_ct_dgm_when *const obj)
{
    return obj->layout_node;
}

pptx_ct_dgm_choose **
pptx_ct_dgm_when_get_choose(const pptx_ct_dgm_when *const obj)
{
    return obj->choose;
}

pptx_ct_a_office_art_extension_list **
pptx_ct_dgm_when_get_ext_lst(const pptx_ct_dgm_when *const obj)
{
    return obj->ext_lst;
}

pptx_string 
pptx_ct_dgm_when_get_name(const pptx_ct_dgm_when *const obj)
{
    return obj->name;
}

pptx_st_axis_type_token_enum 
pptx_ct_dgm_when_get_axis(const pptx_ct_dgm_when *const obj)
{
    return obj->axis;
}

pptx_st_element_type_token_enum 
pptx_ct_dgm_when_get_pt_type(const pptx_ct_dgm_when *const obj)
{
    return obj->pt_type;
}

pptx_bool 
pptx_ct_dgm_when_get_hide_last_trans(const pptx_ct_dgm_when *const obj)
{
    return obj->hide_last_trans;
}

pptx_int 
pptx_ct_dgm_when_get_st(const pptx_ct_dgm_when *const obj)
{
    return obj->st;
}

pptx_uint 
pptx_ct_dgm_when_get_cnt(const pptx_ct_dgm_when *const obj)
{
    return obj->cnt;
}

pptx_int 
pptx_ct_dgm_when_get_step(const pptx_ct_dgm_when *const obj)
{
    return obj->step;
}

pptx_st_function_type_token_enum 
pptx_ct_dgm_when_get_func(const pptx_ct_dgm_when *const obj)
{
    return obj->func;
}

pptx_st_variable_type_token_enum 
pptx_ct_dgm_when_get_arg(const pptx_ct_dgm_when *const obj)
{
    return obj->arg;
}

pptx_st_function_operator_token_enum 
pptx_ct_dgm_when_get_op(const pptx_ct_dgm_when *const obj)
{
    return obj->op;
}

pptx_st_resize_handles_str_token_enum 
pptx_ct_dgm_when_get_val(const pptx_ct_dgm_when *const obj)
{
    return obj->val;
}

int32_t
pptx_ct_dgm_when_get_index(pptx_ct_dgm_when *obj)
{
    return obj->index;
}

void
pptx_ct_dgm_when_free(pptx_ct_dgm_when *obj)
{
    if (obj == NULL)
        return;
    if (obj->alg != NULL) {
