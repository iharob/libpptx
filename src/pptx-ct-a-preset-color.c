...
typedef struct pptx_ct_a_preset_color_s {
    ...
    pptx_st_preset_color_val_token_enum val;
    int32_t index;
} pptx_ct_a_preset_color;

pptx_ct_a_preset_color *
pptx_ct_a_preset_color_new(xmlNode *node)
{
    pptx_ct_a_preset_color *obj;
    ...
    obj->val = pptx_get_st_preset_color_val(node, (const xmlChar *) "val");
    obj->index = pptx_xml_get_node_depth(node);
    return obj;
}

pptx_ct_a_positive_fixed_percentage **
pptx_ct_a_preset_color_get_color_transform_tint(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_tint;
}

pptx_ct_a_positive_fixed_percentage **
pptx_ct_a_preset_color_get_color_transform_shade(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_shade;
}

pptx_ct_a_complement_transform **
pptx_ct_a_preset_color_get_color_transform_comp(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_comp;
}

pptx_ct_a_inverse_transform **
pptx_ct_a_preset_color_get_color_transform_inv(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_inv;
}

pptx_ct_a_grayscale_transform **
pptx_ct_a_preset_color_get_color_transform_gray(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_gray;
}

pptx_ct_a_positive_fixed_percentage **
pptx_ct_a_preset_color_get_color_transform_alpha(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_alpha;
}

pptx_ct_a_fixed_percentage **
pptx_ct_a_preset_color_get_color_transform_alpha_off(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_alpha_off;
}

pptx_ct_a_positive_percentage **
pptx_ct_a_preset_color_get_color_transform_alpha_mod(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_alpha_mod;
}

pptx_ct_a_positive_fixed_angle **
pptx_ct_a_preset_color_get_color_transform_hue(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_hue;
}

pptx_ct_a_angle **
pptx_ct_a_preset_color_get_color_transform_hue_off(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_hue_off;
}

pptx_ct_a_positive_percentage **
pptx_ct_a_preset_color_get_color_transform_hue_mod(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_hue_mod;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_sat(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_sat;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_sat_off(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_sat_off;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_sat_mod(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_sat_mod;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_lum(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_lum;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_lum_off(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_lum_off;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_lum_mod(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_lum_mod;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_red(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_red;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_red_off(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_red_off;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_red_mod(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_red_mod;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_green(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_green;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_green_off(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_green_off;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_green_mod(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_green_mod;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_blue(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_blue;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_blue_off(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_blue_off;
}

pptx_ct_a_percentage **
pptx_ct_a_preset_color_get_color_transform_blue_mod(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_blue_mod;
}

pptx_ct_a_gamma_transform **
pptx_ct_a_preset_color_get_color_transform_gamma(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_gamma;
}

pptx_ct_a_inverse_gamma_transform **
pptx_ct_a_preset_color_get_color_transform_inv_gamma(const pptx_ct_a_preset_color *const obj)
{
    return obj->color_transform_inv_gamma;
}

pptx_st_preset_color_val_token_enum 
pptx_ct_a_preset_color_get_val(const pptx_ct_a_preset_color *const obj)
{
    return obj->val;
}

int32_t
pptx_ct_a_preset_color_get_index(pptx_ct_a_preset_color *obj)
{
    return obj->index;
}

void
pptx_ct_a_preset_color_free(pptx_ct_a_preset_color *obj)
{
    if (obj == NULL)
        return;
    if (obj->color_transform_tint != NULL) {
