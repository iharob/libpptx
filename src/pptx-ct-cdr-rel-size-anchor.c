...
typedef struct pptx_ct_cdr_rel_size_anchor_s {
    pptx_ct_cdr_marker *from;
    pptx_ct_cdr_marker *to;
...
pptx_ct_cdr_rel_size_anchor *
pptx_ct_cdr_rel_size_anchor_new(xmlNode *node)
{
    pptx_ct_cdr_rel_size_anchor *obj;
    ...
    xpath = pptx_xml_find_node(node, (const xmlChar *) "cdr:to");
    if (xpath != NULL) {
        xmlNodeSet *nodes;
        nodes = xpath->nodesetval;
        if ((nodes->nodeNr != 1) || (nodes->nodeNr < -1)) {       
            ...
            obj->to = pptx_ct_cdr_marker_new(nodes->nodeTab[0]);
        }
        xmlXPathFreeObject(xpath);
    } else {
        obj->to = NULL;
...
pptx_ct_cdr_marker *
pptx_ct_cdr_rel_size_anchor_get_from(const pptx_ct_cdr_rel_size_anchor *const obj)
{
    return obj->from;
}

pptx_ct_cdr_marker *
pptx_ct_cdr_rel_size_anchor_get_to(const pptx_ct_cdr_rel_size_anchor *const obj)
{
    return obj->to;
}

pptx_ct_cdr_shape *
pptx_ct_cdr_rel_size_anchor_get_sp(const pptx_ct_cdr_rel_size_anchor *const obj)
{
    return obj->sp;
}

pptx_ct_cdr_group_shape *
pptx_ct_cdr_rel_size_anchor_get_grp_sp(const pptx_ct_cdr_rel_size_anchor *const obj)
{
    return obj->grp_sp;
}

pptx_ct_cdr_graphic_frame *
pptx_ct_cdr_rel_size_anchor_get_graphic_frame(const pptx_ct_cdr_rel_size_anchor *const obj)
{
    return obj->graphic_frame;
}

pptx_ct_cdr_connector *
pptx_ct_cdr_rel_size_anchor_get_cxn_sp(const pptx_ct_cdr_rel_size_anchor *const obj)
{
    return obj->cxn_sp;
}

pptx_ct_cdr_picture *
pptx_ct_cdr_rel_size_anchor_get_pic(const pptx_ct_cdr_rel_size_anchor *const obj)
{
    return obj->pic;
}

int32_t
pptx_ct_cdr_rel_size_anchor_get_index(pptx_ct_cdr_rel_size_anchor *obj)
{
    return obj->index;
}

void
pptx_ct_cdr_rel_size_anchor_free(pptx_ct_cdr_rel_size_anchor *obj)
{
    if (obj == NULL)
        return;
    pptx_ct_cdr_marker_free(obj->from);
    pptx_ct_cdr_marker_free(obj->to);
