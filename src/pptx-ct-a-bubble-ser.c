...
typedef struct pptx_ct_a_bubble_ser_s {
    ...
    pptx_ct_a_num_data_source *bubble_size;
    pptx_bool bubble_3d;
...
pptx_ct_a_bubble_ser *
pptx_ct_a_bubble_ser_new(xmlNode *node)
{
    pptx_ct_a_bubble_ser *obj;
    ...
    xpath = pptx_xml_find_node(node, (const xmlChar *) "a:bubbleSize");
    if (xpath != NULL) {
        xmlNodeSet *nodes;
        nodes = xpath->nodesetval;
        if ((nodes->nodeNr != 1) || (nodes->nodeNr < -1)) {       
            obj->bubble_size = NULL;
        } else {
            obj->bubble_size = pptx_ct_a_num_data_source_new(nodes->nodeTab[0]);
        }
        xmlXPathFreeObject(xpath);
    } else {
        obj->bubble_size = NULL;
...
pptx_uint 
pptx_ct_a_bubble_ser_get_ser_shared_idx(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->ser_shared_idx;
}

pptx_uint 
pptx_ct_a_bubble_ser_get_ser_shared_order(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->ser_shared_order;
}

pptx_ct_a_ser_tx *
pptx_ct_a_bubble_ser_get_ser_shared_tx(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->ser_shared_tx;
}

pptx_ct_a_shape_properties *
pptx_ct_a_bubble_ser_get_ser_shared_sp_pr(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->ser_shared_sp_pr;
}

pptx_bool 
pptx_ct_a_bubble_ser_get_invert_if_negative(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->invert_if_negative;
}

pptx_ct_a_dpt **
pptx_ct_a_bubble_ser_get_d_pt(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->d_pt;
}

pptx_ct_a_dlbls *
pptx_ct_a_bubble_ser_get_d_lbls(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->d_lbls;
}

pptx_ct_a_trendline **
pptx_ct_a_bubble_ser_get_trendline(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->trendline;
}

pptx_ct_a_err_bars **
pptx_ct_a_bubble_ser_get_err_bars(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->err_bars;
}

pptx_ct_a_ax_data_source *
pptx_ct_a_bubble_ser_get_x_val(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->x_val;
}

pptx_ct_a_num_data_source *
pptx_ct_a_bubble_ser_get_y_val(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->y_val;
}

pptx_ct_a_num_data_source *
pptx_ct_a_bubble_ser_get_bubble_size(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->bubble_size;
}

pptx_bool 
pptx_ct_a_bubble_ser_get_bubble_3d(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->bubble_3d;
}

pptx_ct_a_extension_list *
pptx_ct_a_bubble_ser_get_ext_lst(const pptx_ct_a_bubble_ser *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_a_bubble_ser_get_index(pptx_ct_a_bubble_ser *obj)
{
    return obj->index;
}

void
pptx_ct_a_bubble_ser_free(pptx_ct_a_bubble_ser *obj)
{
    if (obj == NULL)
        return;
    ...
    pptx_ct_a_num_data_source_free(obj->bubble_size);
