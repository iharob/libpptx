...
typedef struct pptx_ct_a_color_mru_s {
...
pptx_ct_a_color_mru *
pptx_ct_a_color_mru_new(xmlNode *node)
{
    pptx_ct_a_color_mru *obj;
...
pptx_ct_a_color_mru_get_color_choice_scrgb_clr(const pptx_ct_a_color_mru *const obj)
{
    return obj->color_choice_scrgb_clr;
}

pptx_ct_a_srgb_color **
pptx_ct_a_color_mru_get_color_choice_srgb_clr(const pptx_ct_a_color_mru *const obj)
{
    return obj->color_choice_srgb_clr;
}

pptx_ct_a_hsl_color **
pptx_ct_a_color_mru_get_color_choice_hsl_clr(const pptx_ct_a_color_mru *const obj)
{
    return obj->color_choice_hsl_clr;
}

pptx_ct_a_system_color **
pptx_ct_a_color_mru_get_color_choice_sys_clr(const pptx_ct_a_color_mru *const obj)
{
    return obj->color_choice_sys_clr;
}

pptx_ct_a_scheme_color **
pptx_ct_a_color_mru_get_color_choice_scheme_clr(const pptx_ct_a_color_mru *const obj)
{
    return obj->color_choice_scheme_clr;
}

pptx_ct_a_preset_color **
pptx_ct_a_color_mru_get_color_choice_prst_clr(const pptx_ct_a_color_mru *const obj)
{
    return obj->color_choice_prst_clr;
}

int32_t
pptx_ct_a_color_mru_get_index(pptx_ct_a_color_mru *obj)
{
    return obj->index;
}

void
pptx_ct_a_color_mru_free(pptx_ct_a_color_mru *obj)
{
    if (obj == NULL)
        return;
    if (obj->color_choice_scrgb_clr != NULL) {
