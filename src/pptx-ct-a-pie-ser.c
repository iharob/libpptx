...
typedef struct pptx_ct_a_pie_ser_s {
...
pptx_ct_a_pie_ser *
pptx_ct_a_pie_ser_new(xmlNode *node)
{
    pptx_ct_a_pie_ser *obj;
...
pptx_uint 
pptx_ct_a_pie_ser_get_ser_shared_idx(const pptx_ct_a_pie_ser *const obj)
{
    return obj->ser_shared_idx;
}

pptx_uint 
pptx_ct_a_pie_ser_get_ser_shared_order(const pptx_ct_a_pie_ser *const obj)
{
    return obj->ser_shared_order;
}

pptx_ct_a_ser_tx *
pptx_ct_a_pie_ser_get_ser_shared_tx(const pptx_ct_a_pie_ser *const obj)
{
    return obj->ser_shared_tx;
}

pptx_ct_a_shape_properties *
pptx_ct_a_pie_ser_get_ser_shared_sp_pr(const pptx_ct_a_pie_ser *const obj)
{
    return obj->ser_shared_sp_pr;
}

pptx_uint 
pptx_ct_a_pie_ser_get_explosion(const pptx_ct_a_pie_ser *const obj)
{
    return obj->explosion;
}

pptx_ct_a_dpt **
pptx_ct_a_pie_ser_get_d_pt(const pptx_ct_a_pie_ser *const obj)
{
    return obj->d_pt;
}

pptx_ct_a_dlbls *
pptx_ct_a_pie_ser_get_d_lbls(const pptx_ct_a_pie_ser *const obj)
{
    return obj->d_lbls;
}

pptx_ct_a_ax_data_source *
pptx_ct_a_pie_ser_get_cat(const pptx_ct_a_pie_ser *const obj)
{
    return obj->cat;
}

pptx_ct_a_num_data_source *
pptx_ct_a_pie_ser_get_val(const pptx_ct_a_pie_ser *const obj)
{
    return obj->val;
}

pptx_ct_a_extension_list *
pptx_ct_a_pie_ser_get_ext_lst(const pptx_ct_a_pie_ser *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_a_pie_ser_get_index(pptx_ct_a_pie_ser *obj)
{
    return obj->index;
}

void
pptx_ct_a_pie_ser_free(pptx_ct_a_pie_ser *obj)
{
    if (obj == NULL)
        return;
