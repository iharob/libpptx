...
typedef struct pptx_ct_p_slide_view_properties_s {
...
pptx_ct_p_slide_view_properties *
pptx_ct_p_slide_view_properties_new(xmlNode *node)
{
    pptx_ct_p_slide_view_properties *obj;
...
pptx_ct_p_slide_view_properties_get_c_sld_view_pr(const pptx_ct_p_slide_view_properties *const obj)
{
    return obj->c_sld_view_pr;
}

pptx_ct_p_extension_list *
pptx_ct_p_slide_view_properties_get_ext_lst(const pptx_ct_p_slide_view_properties *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_p_slide_view_properties_get_index(pptx_ct_p_slide_view_properties *obj)
{
    return obj->index;
}

void
pptx_ct_p_slide_view_properties_free(pptx_ct_p_slide_view_properties *obj)
{
    if (obj == NULL)
        return;
