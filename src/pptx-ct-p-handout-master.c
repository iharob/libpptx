...
typedef struct pptx_ct_p_handout_master_s {
    ...
    int32_t index;
} pptx_ct_p_handout_master;

pptx_ct_p_handout_master *
pptx_ct_p_handout_master_new(xmlNode *node)
{
    pptx_ct_p_handout_master *obj;
...
pptx_ct_p_handout_master_get_c_sld(const pptx_ct_p_handout_master *const obj)
{
    return obj->c_sld;
}

pptx_ct_a_color_mapping *
pptx_ct_p_handout_master_get_top_level_slide_clr_map(const pptx_ct_p_handout_master *const obj)
{
    return obj->top_level_slide_clr_map;
}

pptx_ct_p_header_footer *
pptx_ct_p_handout_master_get_hf(const pptx_ct_p_handout_master *const obj)
{
    return obj->hf;
}

pptx_ct_p_extension_list_modify *
pptx_ct_p_handout_master_get_ext_lst(const pptx_ct_p_handout_master *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_p_handout_master_get_index(pptx_ct_p_handout_master *obj)
{
    return obj->index;
}

void
pptx_ct_p_handout_master_free(pptx_ct_p_handout_master *obj)
{
    if (obj == NULL)
        return;
