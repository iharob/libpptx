...
typedef struct pptx_ct_a_area_3dchart_s {
...
pptx_ct_a_area_3dchart *
pptx_ct_a_area_3dchart_new(xmlNode *node)
{
    pptx_ct_a_area_3dchart *obj;
...
pptx_ct_a_grouping *
pptx_ct_a_area_3dchart_get_area_chart_shared_grouping(const pptx_ct_a_area_3dchart *const obj)
{
    return obj->area_chart_shared_grouping;
}

pptx_bool 
pptx_ct_a_area_3dchart_get_area_chart_shared_vary_colors(const pptx_ct_a_area_3dchart *const obj)
{
    return obj->area_chart_shared_vary_colors;
}

pptx_ct_a_area_ser **
pptx_ct_a_area_3dchart_get_area_chart_shared_ser(const pptx_ct_a_area_3dchart *const obj)
{
    return obj->area_chart_shared_ser;
}

pptx_ct_a_dlbls *
pptx_ct_a_area_3dchart_get_area_chart_shared_d_lbls(const pptx_ct_a_area_3dchart *const obj)
{
    return obj->area_chart_shared_d_lbls;
}

pptx_ct_a_chart_lines *
pptx_ct_a_area_3dchart_get_area_chart_shared_drop_lines(const pptx_ct_a_area_3dchart *const obj)
{
    return obj->area_chart_shared_drop_lines;
}

pptx_ct_a_gap_amount *
pptx_ct_a_area_3dchart_get_gap_depth(const pptx_ct_a_area_3dchart *const obj)
{
    return obj->gap_depth;
}

pptx_ct_a_extension_list *
pptx_ct_a_area_3dchart_get_ext_lst(const pptx_ct_a_area_3dchart *const obj)
{
    return obj->ext_lst;
}

int32_t
pptx_ct_a_area_3dchart_get_index(pptx_ct_a_area_3dchart *obj)
{
    return obj->index;
}

void
pptx_ct_a_area_3dchart_free(pptx_ct_a_area_3dchart *obj)
{
    if (obj == NULL)
        return;
