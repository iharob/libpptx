...
typedef struct pptx_ct_a_custom_color_s {
...
pptx_ct_a_custom_color *
pptx_ct_a_custom_color_new(xmlNode *node)
{
    pptx_ct_a_custom_color *obj;
...
pptx_ct_a_custom_color_get_color_choice_scrgb_clr(const pptx_ct_a_custom_color *const obj)
{
    return obj->color_choice_scrgb_clr;
}

pptx_ct_a_srgb_color *
pptx_ct_a_custom_color_get_color_choice_srgb_clr(const pptx_ct_a_custom_color *const obj)
{
    return obj->color_choice_srgb_clr;
}

pptx_ct_a_hsl_color *
pptx_ct_a_custom_color_get_color_choice_hsl_clr(const pptx_ct_a_custom_color *const obj)
{
    return obj->color_choice_hsl_clr;
}

pptx_ct_a_system_color *
pptx_ct_a_custom_color_get_color_choice_sys_clr(const pptx_ct_a_custom_color *const obj)
{
    return obj->color_choice_sys_clr;
}

pptx_ct_a_scheme_color *
pptx_ct_a_custom_color_get_color_choice_scheme_clr(const pptx_ct_a_custom_color *const obj)
{
    return obj->color_choice_scheme_clr;
}

pptx_ct_a_preset_color *
pptx_ct_a_custom_color_get_color_choice_prst_clr(const pptx_ct_a_custom_color *const obj)
{
    return obj->color_choice_prst_clr;
}

pptx_string 
pptx_ct_a_custom_color_get_name(const pptx_ct_a_custom_color *const obj)
{
    return obj->name;
}

int32_t
pptx_ct_a_custom_color_get_index(pptx_ct_a_custom_color *obj)
{
    return obj->index;
}

void
pptx_ct_a_custom_color_free(pptx_ct_a_custom_color *obj)
{
    if (obj == NULL)
        return;
